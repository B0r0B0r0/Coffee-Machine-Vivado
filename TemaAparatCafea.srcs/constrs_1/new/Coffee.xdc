...
set_property PACKAGE_PIN P17 [get_ports coin_in]
set_property PACKAGE_PIN H17 [get_ports led_idle]
set_property PACKAGE_PIN K15 [get_ports led_insufficient]
set_property PACKAGE_PIN J13 [get_ports led_preparing]
set_property PACKAGE_PIN J15 [get_ports reset_in]
...
set_property PACKAGE_PIN M17 [get_ports {drink_sel[2]}]
set_property PACKAGE_PIN M18 [get_ports {drink_sel[1]}]
set_property PACKAGE_PIN P18 [get_ports {drink_sel[0]}]
